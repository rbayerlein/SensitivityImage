function make_senimg0(nc_file, senimg_name, att_image_name, cryseff_name, plaeff_name, first_bed_ring, num_beds, rings_per_bed, overlap_percent, blockringdiff_no)
