...
P3=\'/media/rbayerlein/data/recon_data/20200124/sen_img/crys_eff_679x840\'		#crys eff map WITH gaps, file WILL BE CREATED at that location
P4=\'/media/rbayerlein/data/recon_data/20200124/sen_img/plane_eff_679x679\'		#plane eff map WITH gaps, file WILL BE CREATED at that location
