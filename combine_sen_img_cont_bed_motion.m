function combine_sen_img_cont_bed_motion(senimg_name, num_beds, rings_per_bed, bedStartRing)
% this function creates sen img for continuous bed motion, where the bed is
% shifted by 1 crystal ring at a time
...
final_ring = bedStartRing + rings_per_bed + num_beds -1
